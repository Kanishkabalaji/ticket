...
<script>
 function NewTab() { 
            window.open( 
              "redirect4.html","", "width=1080, height=1000"); 
        }
</script>
</head>
<body align=center>
...
echo "<tr><td>3</td><td>$s4</td><td>$us4</td><td>$age4</td><td>$gender4</td></tr>";
echo "</table>";
			...
			$sql3="INSERT INTO f1 (s1,us1,age1,gender1) values ('$s4','$us4','$age4','$gender4')";
...
?>	
<p align=right>Total Fare:<br> Rs.4800</p>
